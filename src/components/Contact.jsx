...
export default function Contact({ dark }) {
  ...
  const inputStyle = (field) => ({
    ...
    border: `1px solid ${focus === field ? "#00f5a0" : dark ? "rgba(255,255,255,0.1)" : "rgba(0,0,0,0.1)"}`,
    color: dark ? "#fff" : "#0a0a0f", outline: "none",
    transition: "all 0.2s", boxSizing: "border-box",
    boxShadow: focus === field ? "0 0 0 3px rgba(0,245,160,0.1)" : "none",
  });

  return (
    <section id="contact" ref={ref} style={{ padding: "120px 2rem 80px" }}>
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          ...
          <h2 style={{
            ...
            Prendre <span style={{ color: "#00f5a0" }}>Contact</span>
          </h2>
          <p style={{ fontFamily: "'DM Sans', sans-serif", color: dark ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.5)", marginTop: 16, fontSize: 15 }}>
          ...
          {sent ? (
            ...
            >
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  right: 0,
                  height: 4,
                  background: "linear-gradient(90deg, transparent, #00f5a0, #00d4ff, transparent)",
                  borderRadius: 2,
                }} />
              ...
              >
                <h3 style={{ color: "#00f5a0", marginBottom: 2, fontSize: 40 }}>
                  Message envoyé !
                </h3>
            ...
            <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <div>
                  <label style={{ fontFamily: "'Space Mono', monospace", fontSize: 11, color: "#00f5a0", letterSpacing: "0.1em", display: "block", marginBottom: 8, textTransform: "uppercase" }}>Nom</label>
                  <input value={form.name} onChange={e => setForm({ ...form, name: e.target.value })}
                    onFocus={() => setFocus("name")} onBlur={() => setFocus(null)}
                    placeholder="John Doe" required style={inputStyle("name")} />
                </div>
                <div>
                  <label style={{ fontFamily: "'Space Mono', monospace", fontSize: 11, color: "#00f5a0", letterSpacing: "0.1em", display: "block", marginBottom: 8, textTransform: "uppercase" }}>Email</label>
              ...
              <div>
                <label style={{ fontFamily: "'Space Mono', monospace", fontSize: 11, color: "#00f5a0", letterSpacing: "0.1em", display: "block", marginBottom: 8, textTransform: "uppercase" }}>Message</label>

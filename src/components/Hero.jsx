...
export default function Hero({ dark }) {
  ...
  return (
    <section id="about" style={{
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        {[...Array(6)].map((_, i) => (
          <div key={i} style={{
            position: "absolute",
            borderRadius: "50%",
            background: `radial-gradient(circle, ${i % 2 === 0 ? "rgba(0,245,160,0.06)" : "rgba(124,58,237,0.06)"} 0%, transparent 70%)`,
            width: `${300 + i * 80}px`,
            height: `${300 + i * 80}px`,
            top: `${10 + i * 8}%`,
            left: `${-10 + i * 15}%`,
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", width: "100%", zIndex: 1, display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
        <div>
          <div style={{ animation: "slideUp 0.8s ease both", animationDelay: "0.1s" }}>
            <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 13, color: "#00f5a0", letterSpacing: "0.2em", textTransform: "uppercase", display: "block", marginBottom: 16 }}>
              // Bonjour, je suis
            </span>
          </div>
          <div style={{ animation: "slideUp 0.8s ease both", animationDelay: "0.1s" }}>
            <h1 style={{
              ...
              Yannick Mariano<br />
              <span style={{ color: "#00f5a0" }}>RAKOTONIHARANTSOA</span>
            </h1>
          </div>
          <div style={{ animation: "slideUp 0.8s ease both", animationDelay: "0.4s" }}>
            <div style={{
              ...
              <span style={{ color: "#7c3aed" }}>&gt;</span> {typed}
              <span style={{ animation: "blink 1s infinite", color: "#00f5a0" }}>█</span>
            </div>
          </div>
          ...
          <div style={{ animation: "slideUp 0.8s ease both", animationDelay: "0.7s", display: "flex", gap: 16, flexWrap: "wrap" }}>
            <button 
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = "0 0 50px rgba(0,245,160,0.5)";
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = "none";
                e.currentTarget.style.boxShadow = "0 0 30px rgba(0,245,160,0.3)";
              }}>
              Télécharger mon CV →
            </button>
...
<div style={{ display: "flex", justifyContent: "center", alignItems: "center", animation: "fadeIn 1.2s ease both", animationDelay: "0.5s" }}>
  <div style={{ position: "relative", width: 520, height: 520 }}>
    ...
    <div style={{
      ...
      <div style={{
        ...
        background: "linear-gradient(135deg, #00f5a0, #7c3aed, #00d4ff)",
        padding: "3px",
        animation: "pulse 4s ease-in-out infinite",
        boxShadow: "0 0 40px rgba(0,245,160,0.4)",
      }}>
        <div style={{
          width: "100%", height: "100%", borderRadius: "50%",
          overflow: "hidden",
    ...
    {[180, 240, 300, 360, 420, 480, 540].map((r, i) => (
      <div key={i} style={{
        ...
        borderRadius: "50%",
        border: `1px solid ${dark ? `rgba(0,245,160,${0.02 + i * 0.005})` : "rgba(0,0,0,0.01)"}`,
        pointerEvents: "none",
      }} />
    ))}
